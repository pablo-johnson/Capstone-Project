...
import com.johnson.pablo.sharebook.util.DialogUtils;


/**
 * @author Pablo Johnson (pablo.88j@gmail.com)
 */
public class ShareBookActivity extends AppCompatActivity implements ShareBookFragmentListener {
    ...
    public void replaceFragment(Fragment fragment, boolean addToBackStack) {
        replaceFragment(R.id.container, fragment, addToBackStack);
    }
